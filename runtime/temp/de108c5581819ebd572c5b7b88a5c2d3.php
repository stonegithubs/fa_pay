<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpstudy_pro\WWW\fa_pay\public/../application/admin\view\auth\admin\edit.html";i:1616664694;s:69:"D:\phpstudy_pro\WWW\fa_pay\application\admin\view\layout\default.html";i:1616664694;s:66:"D:\phpstudy_pro\WWW\fa_pay\application\admin\view\common\meta.html";i:1616664694;s:68:"D:\phpstudy_pro\WWW\fa_pay\application\admin\view\common\script.html";i:1616664694;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="number" class="form-control" disabled  autocomplete="off" value="<?php echo $row['appid']; ?>" data-rule="required;" />
        </div>
    </div>
    ...
    <div class="form-group">
        <label  class="control-label col-xs-12 col-sm-2">appsecret:</label>
        <div class="col-xs-10 col-sm-8">
            <input id="c-appsecret" readonly data-rule="required" class="form-control" value="<?php echo $row['appsecret']; ?>" name="row[appsecret]" type="text">
